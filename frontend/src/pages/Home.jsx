...
function App() {
  ...
  const categories = [
    ...
    {
      name: "Skincare",
      image: "https://images.unsplash.com/photo-1611078489935-0cb964de46e5?w=200&h=200&fit=crop&crop=faces",
      count: "95+ products",
    },
    {
      name: "Tools",
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <nav className="hidden md:block py-4">
              <ul className="flex items-center space-x-8">
                <li>
                  <Link to="/new" className="text-gray-700 hover:text-rose-600 font-medium transition-colors">
                    New Arrivals
                  </Link>
                </li>
                <li>
